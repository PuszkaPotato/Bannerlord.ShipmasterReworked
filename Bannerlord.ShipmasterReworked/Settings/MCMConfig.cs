...
namespace Bannerlord.ShipmasterReworked.Settings
{
    public sealed class MCMConfig : AttributeGlobalSettings<MCMConfig>
    {
        ...
        [SettingPropertyBool("Enable Travel XP Debug Messages", Order = 9, RequireRestart = false,
        ...
        [SettingPropertyBool("Enable Ramming XP Debug Messages", Order = 9, RequireRestart = false,
